...
<template>
  <section
    class="max-w-5xl mx-auto px-6 py-24 md:py-32 grid md:grid-cols-2 gap-12 md:gap-16 items-end border-b border-stone-200"
  ...
  >
    <div>
      ...
      <h1
        id="hero-heading"
        class="font-serif text-5xl md:text-6xl leading-tight text-slate-800 font-normal"
      >
        Código que<br />
        funciona para<br />
